...
describe("BestBuy (Storefront headless)", function () {
  ...
  //   await browser.CoveoSearch("running shoes", TheGYMSelectors);
  //   await browser.CoveoClickResult("", TheGYMSelectors);
  // });
  ...
  //   await browser.CoveoClickResultByText("MacBook 12\" Retina Display - Intel Core i5 - 8GB Memory - 512GB Flash Storage");
  // });
